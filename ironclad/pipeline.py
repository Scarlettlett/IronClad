...
if __name__ == "__main__":
    # SAMPLE TEST
    # Initialize pipeline
    pipeline = Pipeline('casia-webface', index_type='HNSW', metric='euclidean')

    # Precomput and save the gallery index
    gallery_path = "storage\\sample_gallery"

    pipeline.precompute_and_save("storage/sample_gallery", "storage/sample_catalog", "storage/sample_catalog")
    ...
    results = pipeline.search_gallery(sample_probe, k=4)
